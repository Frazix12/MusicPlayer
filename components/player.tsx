...
export function Player() {
  ...
  return (
    <motion.div
      ...
      transition={{ duration: 0.5 }}
    >
      <Card className="w-64 h-64 mb-6 overflow-hidden bg-gradient-to-br from-purple-500/20 to-pink-500/20 border-purple-500/30 rounded-2xl shadow-2xl">
      ...
      >
        ...
        {currentSong.album && (
          <p className="text-sm text-muted-foreground/80 mt-1 truncate">{currentSong.album}</p>
        )}
      </motion.div>
    </motion.div>
  )
